...
| Styling | CSS custom properties (`assets/cfc-tokens.css`) + Tailwind via CDN on eight pages |
...
| `cfc-tailwind.js` | Tailwind CDN theme, mapping colour names to the CSS variables | The eight Tailwind pages |
