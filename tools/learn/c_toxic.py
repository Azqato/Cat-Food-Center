...
build(
    ...
    lede="Two quirks of feline physiology &mdash; a liver that cannot glucuronidate and haemoglobin that oxidises easily &mdash; make cats vulnerable to things other animals shrug off. This page covers what is genuinely dangerous and what to do about it.",
    body=BODY,
)
