...
cards([
    ("{{root}}learn/daily-requirements/", "The core answer",
    ...
    ("{{root}}learn/nutrition/", "Foundations",
...
cards([
    ("{{root}}methodology/", None, "The CFC Score methodology",
     "How we turn this science into a 0–100 score for a specific product."),
    ("{{root}}search/", None, "Search the catalogue",
