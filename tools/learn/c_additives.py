...
build(
    ...
    lede="Some additives are documented hazards to cats, some are contested, and a good many are attacked online without cause. This page sorts them into three tiers by the strength of the evidence &mdash; and says plainly where the evidence runs out.",
    body=BODY,
)
