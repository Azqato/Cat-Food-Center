...
PROFILE_ROWS = [
    ...
    ["Crude protein (%)", "30.0", "26.0", "&mdash;"],
    ["Arginine (%)", "1.25", "1.04", "&mdash;"],
    ["Histidine (%)", "0.31", "0.31", "&mdash;"],
    ["Isoleucine (%)", "0.52", "0.52", "&mdash;"],
    ["Leucine (%)", "1.25", "1.25", "&mdash;"],
    ["Lysine (%)", "1.20", "0.83", "&mdash;"],
    ["Methionine (%)", "0.62", "0.62", "1.5"],
    ["Methionine + cystine (%)", "1.10", "1.10", "&mdash;"],
    ["Phenylalanine (%)", "0.42", "0.42", "&mdash;"],
    ["Phenylalanine + tyrosine (%)", "0.88", "0.88", "&mdash;"],
    ["Threonine (%)", "0.73", "0.73", "&mdash;"],
    ["Tryptophan (%)", "0.25", "0.16", "&mdash;"],
    ["Valine (%)", "0.62", "0.62", "&mdash;"],
    ["<strong>Taurine, extruded / dry (%)</strong>", "0.10", "0.10", "&mdash;"],
    ["<strong>Taurine, canned / wet (%)</strong>", "0.20", "0.20", "&mdash;"],
    "Fat and fatty acids",
    ["Crude fat (%)", "9.0", "9.0", "&mdash;"],
    ["Linoleic acid (%)", "0.5", "0.5", "&mdash;"],
    ["Arachidonic acid (%)", "0.02", "0.02", "&mdash;"],
    "Minerals",
    ["Calcium (%)", "1.0", "0.6", "&mdash;"],
    ["Phosphorus (%)", "0.8", "0.5", "&mdash;"],
    ["Potassium (%)", "0.6", "0.6", "&mdash;"],
    ["Sodium (%)", "0.2", "0.2", "&mdash;"],
    ["Chloride (%)", "0.3", "0.3", "&mdash;"],
    ["Magnesium (%)", "0.08", "0.04", "&mdash;"],
    ["Iron (mg/kg)", "80", "80", "&mdash;"],
    ["Copper (mg/kg)", "5", "5", "&mdash;"],
    ["Manganese (mg/kg)", "7.5", "7.5", "&mdash;"],
    ["Zinc (mg/kg)", "75", "75", "2,000"],
    ["Iodine (mg/kg)", "0.35", "0.35", "&mdash;"],
    ["Selenium (mg/kg)", "0.1", "0.1", "&mdash;"],
    "Vitamins",
    ["Vitamin A (IU/kg)", "9,000", "5,000", "750,000"],
    ["Vitamin D (IU/kg)", "750", "500", "10,000"],
    ["Vitamin E (IU/kg)", "30", "30", "&mdash;"],
    ["Vitamin K (mg/kg)", "0.1", "0.1", "&mdash;"],
    ["Thiamine, B<sub>1</sub> (mg/kg)", "5.0", "5.0", "&mdash;"],
    ["Riboflavin, B<sub>2</sub> (mg/kg)", "4.0", "4.0", "&mdash;"],
    ["Pantothenic acid, B<sub>5</sub> (mg/kg)", "5.0", "5.0", "&mdash;"],
    ["Niacin, B<sub>3</sub> (mg/kg)", "60", "60", "&mdash;"],
    ["Pyridoxine, B<sub>6</sub> (mg/kg)", "4.0", "4.0", "&mdash;"],
    ["Folic acid (mg/kg)", "0.8", "0.8", "&mdash;"],
    ["Biotin (mg/kg)", "0.07", "0.07", "&mdash;"],
    ["Vitamin B<sub>12</sub> (mg/kg)", "0.02", "0.02", "&mdash;"],
    ["Choline (mg/kg)", "2,400", "2,400", "&mdash;"],
]
...
"""<p><strong>1 &mdash; Resting energy.</strong> <code>RER = 70 &times; 4.5^0.75 = 70 &times; 3.09 = 216 kcal/day</code></p>
<p><strong>2 &mdash; Maintenance.</strong> <code>MER = 216 &times; 1.2 = 260 kcal/day</code></p>
<p><strong>3 &mdash; Dry matter eaten.</strong> <code>260 kcal &divide; 4 kcal/g = 65 g of dry matter per day</code></p>
...
build(
    ...
    lede="A cat's daily requirement is not one number &mdash; it is 42 of them, plus energy and water. This page gives the complete list, the safe upper limits, and the arithmetic that turns a label percentage into grams in the bowl.",
    body=BODY,
)
