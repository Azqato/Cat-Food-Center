...
PATHS = [
    ('/index.html', 'home'),
    ('/search.html', 'search, no query'),
    ('/search.html?q=chicken', 'search results'),
    ('/search.html?brand=purina%7CPurina', 'brand-filtered results'),
    ('/brands.html', 'brand index'),
    ('/product.html?barcode=4008429158100', 'product, fully scored'),
    ('/product.html?barcode=0050000102068', 'product, no ingredients'),
    ('/product.html?barcode=9999999999999', 'product, not in database'),
    ('/scan.html', 'scan'),
    ('/submit.html?barcode=9999999999999', 'submit'),
    ('/compare.html', 'compare, empty'),
    ('/compare.html?a=0064992282189&b=3596710487455', 'compare, two products'),
    ('/methodology.html', 'methodology'),
    ('/offline.html', 'offline'),
    ('/learn.html', 'guide index'),
    ('/learn-nutrition.html', 'guide: nutrition'),
    ('/learn-daily-requirements.html', 'guide: daily requirements'),
    ('/learn-labels.html', 'guide: labels'),
    ('/learn-food-types.html', 'guide: food types'),
    ('/learn-hydration.html', 'guide: hydration'),
    ('/learn-additives.html', 'guide: additives'),
    ('/learn-feeding.html', 'guide: feeding'),
    ('/learn-life-stages.html', 'guide: life stages'),
    ('/learn-toxic.html', 'guide: toxic foods'),
    ('/learn-health.html', 'guide: health'),
]
